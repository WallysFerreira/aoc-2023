defmodule Day7Part1Test do
  ...
  describe "compares hands" do
    test "AAAAA and 23456" do
      assert Day7Part1.compare(String.split("AAAAA", "", trim: :true), String.split("23456", "", trim: :true)) == 1
      assert Day7Part1.compare(String.split("23456", "", trim: :true), String.split("AAAAA", "", trim: :true)) == 2
    end

    test "33332 and 2AAAA" do
      assert Day7Part1.compare(String.split("33332", "", trim: :true), String.split("2AAAA", "", trim: :true)) == 1
      assert Day7Part1.compare(String.split("2AAAA", "", trim: :true), String.split("33332", "", trim: :true)) == 2
    end

    test "77888 and 77788" do
      assert Day7Part1.compare(String.split("77888", "", trim: :true), String.split("77788", "", trim: :true)) == 1
      assert Day7Part1.compare(String.split("77788", "", trim: :true), String.split("77888", "", trim: :true)) == 2
    end

    test "KK677 and KTJJT" do
      assert Day7Part1.compare(String.split("KK677", "", trim: :true), String.split("KTJJT", "", trim: :true)) == 1
      assert Day7Part1.compare(String.split("KTJJT", "", trim: :true), String.split("KK677", "", trim: :true)) == 2
    end
